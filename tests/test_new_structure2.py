...
def test_imports():
    ...
    try:
        ...
        from src.data_prep.hurricane_helper import (
            HurricaneDownloader,
            HurricaneAnalyzer,
            HurricaneVisualizer,
        )
        ...
        from src.data_prep.hurricane_helper.hurricane_downloader import (
            HurricaneDownloader,
        )
        from src.data_prep.hurricane_helper.hurricane_analyzer import HurricaneAnalyzer
        from src.data_visualization.hurricane_visualizer import (
            HurricaneVisualizer,
        )
